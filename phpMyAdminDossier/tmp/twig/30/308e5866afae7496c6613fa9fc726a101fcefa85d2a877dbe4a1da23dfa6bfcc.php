...
class __TwigTemplate_264607a860a1347289eea7029ffd7f906ac54fdcc14b9d99c17129c939b41f87 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Any");
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["priv"]) {
                    ...
                    ";
                    // line 48
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["priv"], "type", [], "any", false, false, false, 48), "g"))) {
                        // line 49
                        echo "                      ";
echo _gettext("global");
                        // line 50
                        echo "                    ";
                    } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["priv"], "type", [], "any", false, false, false, 50), "d"))) {
                        // line 51
                        echo "                      ";
                        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["priv"], "database", [], "any", false, false, false, 51), twig_replace_filter(($context["db"] ?? null), ["_" => "\\_", "%" => "\\%"])))) {
                            // line 52
                            echo "                        ";
...
echo _gettext("wildcard");
                      ...
                      ";
                        ...
                        // line 56
                        echo "                    ";
                    } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["priv"], "type", [], "any", false, false, false, 56), "t"))) {
                        // line 57
                        echo "                      ";
echo _gettext("table-specific");
                        // line 58
                        echo "                    ";
                    } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["priv"], "type", [], "any", false, false, false, 58), "r"))) {
                        // line 59
                        echo "                      ";
echo _gettext("routine");
                  ...
                  <td>
                    <code>
                      ";
                    // line 64
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["priv"], "type", [], "any", false, false, false, 64), "r"))) {
                        // line 65
                        echo "                        ";
...
$context["privilege"], "host", [], "any", false, false, false, 79), "dbname" => (((0 !== twig_compare(twig_get_attribute($this->env, $this->source,                         // line 80
...
$context["priv"], "table", [], "any", true, true, false, 81) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["priv"], "table", [], "any", false, false, false, 81), "*")))) ? (twig_get_attribute($this->env, $this->source, $context["priv"], "table", [], "any", false, false, false, 81)) : ("")), "routinename" => (((twig_get_attribute($this->env, $this->source,                         // line 82
...
";
    ...
    {
        return new Source("", "table/privileges/index.twig", "C:\\MAMP\\htdocs\\phpMyAdminDossier\\templates\\table\\privileges\\index.twig");
    }
}
